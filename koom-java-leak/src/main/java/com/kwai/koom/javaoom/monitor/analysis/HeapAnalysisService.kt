...
//            if (instance.instanceClassName.startsWith("com.kwai.koom.demo")) {
//
//                LoggerUtils.LOGV("instanceClassName  ${instance.instanceClassName} ${instance.objectId}   ${instance.instanceClassId}")
//
//                instance.readFields().iterator().forEach {
//                    LoggerUtils.LOGV("instanceClassName  ${it.name}  ${it.value}")
//                }
//            }
